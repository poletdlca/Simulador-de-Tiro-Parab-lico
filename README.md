...
`[45°, 90°]`. Por eso la búsqueda binaria se restringe al tramo `[0°, 45°]` para encontrar el ángulo que produce un
alcance lo más cercano posible al alcance objetivo solicitado.

## Uso del menú

1. Simular nuevo lanzamiento
2. Mostrar resumen del último lanzamiento (tiempo de vuelo, altura y alcance)
3. Guardar trayectoria en CSV
...
7. Buscar el ángulo óptimo para alcanzar una distancia objetivo
